...
`external_full_workflow.glb` was generated by `generate_external_full_workflow.py` with the official Blender 4.3 glTF 2.0 exporter. It combines a named external humanoid armature, non-unit source scale, two mesh primitives, six carried skin influences, two partial actions, OPAQUE and MASK materials, embedded PBR images, Emissive, and Occlusion. The generator and fixture contain no third-party source asset.
